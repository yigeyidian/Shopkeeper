...
import com.admin.shopkeeper.adapter.RetCauseAdapter;
...
public class ReturnCauseActivity extends BaseActivity<ReturnCausePresenter> implements IReturnCauseView {

    @BindView(R.id.toolbar)
    Toolbar toolbar;
    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;
    private RetCauseAdapter adapter;
    private PopupWindow laheiPop;

    @Override
    protected void initPresenter() {
        presenter = new ReturnCausePresenter(this, this);
        presenter.init();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_return_cause;
    }
    ...
    public void initView() {
        ...
        recyclerView.addItemDecoration(new HorizontalDividerItemDecoration.Builder(this)
                ...
                .build());
        adapter = new RetCauseAdapter(this);
    ...
    @Override
    public void success(List<RetCauseBean> retCauseBeen) {
        adapter.setDatas(retCauseBeen);
    }
    ...
    public void showDeletePop(RetCauseBean bean) {
        ...
        laheiView.findViewById(R.id.pop_edit).setOnClickListener(v -> {
            Intent intent = new Intent(ReturnCauseActivity.this, EditActivity.class);

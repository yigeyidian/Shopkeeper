...
import com.admin.shopkeeper.adapter.FoodKouweiAdapter;
...
import com.admin.shopkeeper.ui.activity.activityOfBoss.kouweiedit.KouweiEditActivity;
...
public class SeasonActivity extends BaseActivity<SeasonPresenter> implements ISeasonView {
    ...
    private FoodSeasonAdapter adapter;
    private FoodBean foodBean;

    @Override
    protected void initPresenter() {
        presenter = new SeasonPresenter(this,this);
        presenter.init();
    }
    ...
    public void initView() {
        ...
        recyclerView.addItemDecoration(new HorizontalDividerItemDecoration.Builder(this)
                ...
                .build());
        adapter = new FoodSeasonAdapter(R.layout.item_season);
    ...
    public void showDeletePop(SeasonBean bean) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_add:
                Intent intent = new Intent(this, SeasonEditActivity.class);
    ...
    @Override
    public void success(List<SeasonBean> datas) {

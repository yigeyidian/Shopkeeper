...
public class PrintClass58 {
    ...
    public PrintClass58(String IPs, String types, String products, String tnames, String snames, String personcounts, String shijis, String yinshous, String cuttypes, String usernames) {
        IP = IPs;
        type = types;
        product = products;
        tname = tnames;

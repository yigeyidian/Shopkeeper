...
public class ReturnBussinessActivity extends BaseActivity<ReturnBussinessPresenter> implements IReturnBussinessView ,
    ...
    private ReturnBussinessAdapter adapter;
    private PopupWindow popupWindow;


    @Override
    protected void initPresenter() {
        presenter = new ReturnBussinessPresenter(this, this);
        presenter.init();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_return_bussiness;
    }
    ...
    public void initView() {
        ...
        recyclerView.addItemDecoration(new HorizontalDividerItemDecoration.Builder(this)
                ...
                .build());
        adapter = new ReturnBussinessAdapter(R.layout.item_foodbussiness);
    ...
    public void countClick() {
        ...
        if (countType % 3 == 1) {
            ...
            List<ReturnBussinessBean> newData = new ArrayList<>();
            newData.addAll(data);
    ...
    List<ReturnBussinessBean> data;
    @Override
    public void success(List<ReturnBussinessBean> data) {
        this.data = data;
        adapter.setNewData(data);
        if (popupWindow != null) {
            popupWindow.dismiss();

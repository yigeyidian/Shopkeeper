...
import com.admin.shopkeeper.adapter.PayBussinessAdapter;
...
public class PayBussinessActivity extends BaseActivity<PayBussinessPresenter> implements IPayBussinessView ,
    ...
    TextView tvMoney;
    private PayBussinessAdapter adapter;
    private PopupWindow popupWindow;

    @Override
    protected void initPresenter() {
        presenter = new PayBussinessPresenter(this, this);
        presenter.init();
    }
    ...
    public void initView() {
        ...
        recyclerView.addItemDecoration(new HorizontalDividerItemDecoration.Builder(this)
                ...
                .build());
        adapter = new PayBussinessAdapter(R.layout.item_foodbussiness);
    ...
    public void countClick() {
        ...
        if (countType % 3 == 1) {
            ...
            List<PayBussinessBean> newData = new ArrayList<>();
            newData.addAll(data);
            ...
            newData.addAll(data);
            Collections.sort(newData, (o1, o2) -> {
                return o2.getPayType().compareTo(o1.getPayType());
            });
            adapter.setNewData(newData);
        } else {
    ...
    List<PayBussinessBean> data;
    @Override
    public void success(List<PayBussinessBean> data) {
        this.data = data;
        adapter.setNewData(data);
        if (popupWindow != null) {
            popupWindow.dismiss();

...
public class KouweiActivity extends BaseActivity<KouweiPresenter> implements IKouweiView {
    ...
    private FoodKouweiAdapter adapter;
    private FoodBean foodBean;

    @Override
    protected void initPresenter() {
        presenter = new KouweiPresenter(this, this);
        presenter.init();
    }
    ...
    public void initView() {
        ...
        recyclerView.addItemDecoration(new HorizontalDividerItemDecoration.Builder(this)
                ...
                .build());
        adapter = new FoodKouweiAdapter(R.layout.item_kouwei);
    ...
    public void showDeletePop(KouweiBean bean) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_add:
                Intent intent = new Intent(this, KouweiEditActivity.class);
    ...
    @Override
    public void success(List<KouweiBean> datas) {

...
public class CollectionStatisticsPresenter extends BasePresenter<ICollectionStatisticsView> {

    public CollectionStatisticsPresenter(Context context, ICollectionStatisticsView iView) {
        super(context, iView);
    }

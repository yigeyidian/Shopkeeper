...
import com.admin.shopkeeper.adapter.DetailBussinessAdapter;
...
public class DetailBussinessActivity extends BaseActivity<DetailBussinessPresenter> implements IDetailBussinessView ,
    ...
    private DetailBussinessAdapter adapter;
    private PopupWindow popupWindow;

    @Override
    protected void initPresenter() {
        presenter = new DetailBussinessPresenter(this, this);
        presenter.init();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_detail_bussiness;
    }
    ...
    public void initView() {
        ...
        toolbar.setTitle("退菜明细");
        toolbar.setNavigationIcon(R.mipmap.navigation_icon_repeat);
        setSupportActionBar(toolbar);

        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new DetailBussinessAdapter(R.layout.item_detailbussiness);
    ...
    @Override
    public void success(List<DetailBussinessBean> data) {

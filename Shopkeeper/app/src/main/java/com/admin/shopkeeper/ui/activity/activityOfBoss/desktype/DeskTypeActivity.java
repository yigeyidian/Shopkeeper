...
import com.admin.shopkeeper.adapter.DeskTypeAdapter;
import com.admin.shopkeeper.base.BaseActivity;
import com.admin.shopkeeper.entity.DeskTypeBean;
import com.admin.shopkeeper.ui.activity.activityOfBoss.desktypeedit.DeskTypeEditActivity;
...
public class DeskTypeActivity extends BaseActivity<DeskTypePresenter> implements IDeskTypeView {
    ...
    private DeskTypeAdapter adapter;

    @Override
    protected void initPresenter() {
        presenter = new DeskTypePresenter(this,this);
        presenter.init();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_desk_type;
    }
    ...
    public void initView() {
        ...
        recyclerView.addItemDecoration(new HorizontalDividerItemDecoration.Builder(this)
                ...
                .build());
        adapter = new DeskTypeAdapter(R.layout.item_desktype);
    ...
    public void showDeletePop(DeskTypeBean bean) {
        ...
        laheiView.findViewById(R.id.pop_edit).setOnClickListener(v -> {
            Intent intent = new Intent(this, DeskTypeEditActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_add:
                startActivityForResult(DeskTypeEditActivity.class, 101);
                break;
        }
    ...
    @Override
    public void success(List<DeskTypeBean> datas) {

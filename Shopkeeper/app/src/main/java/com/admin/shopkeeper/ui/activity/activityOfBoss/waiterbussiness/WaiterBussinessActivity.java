...
import com.admin.shopkeeper.adapter.WaiterBussinessAdapter;
...
public class WaiterBussinessActivity extends BaseActivity<WaiterBussinessPresenter> implements IWaiterBussinessView ,
    ...
    private WaiterBussinessAdapter adapter;
    private PopupWindow popupWindow;

    @Override
    protected void initPresenter() {
        presenter = new WaiterBussinessPresenter(this, this);
        presenter.init();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_waiter_bussiness;
    }
    ...
    public void initView() {
        ...
        recyclerView.addItemDecoration(new HorizontalDividerItemDecoration.Builder(this)
                ...
                .build());
        adapter = new WaiterBussinessAdapter(R.layout.item_foodbussiness);
    ...
    public void countClick() {
        ...
        if (countType % 3 == 1) {
            ...
            List<WaiterBussinessBean> newData = new ArrayList<>();
            newData.addAll(data);
    ...
    List<WaiterBussinessBean> data;

    @Override
    public void success(List<WaiterBussinessBean> data) {
        this.data = data;
        adapter.setNewData(data);
        if (popupWindow != null) {
            popupWindow.dismiss();

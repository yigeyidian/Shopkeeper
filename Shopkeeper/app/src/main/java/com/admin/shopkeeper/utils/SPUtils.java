...
public class SPUtils {
    ...
    private static final String PREFERENCE_NAME = "shopkeeper";
    public static final String PREFERENCE_SHOP_ID = "shopID";
    ...
    public static final String PREFERENCE_ROOM = "room";
    public static final String PREFERENCE_MENU = "menu";
    public static final String PREFERENCE_MEAL = "meal";
    ...
    public static SPUtils getInstance() {
        ...
        SPUtils sp = sSPMap.get(PREFERENCE_NAME);
        if (sp == null) {
            sp = new SPUtils();
            sSPMap.put(PREFERENCE_NAME, sp);
        }
        return sp;
    }

    private SPUtils() {
        sp = App.getAPPContext().getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
    }

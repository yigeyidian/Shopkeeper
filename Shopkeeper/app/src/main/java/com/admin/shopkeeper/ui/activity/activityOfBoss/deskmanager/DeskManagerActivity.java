...
import com.admin.shopkeeper.adapter.DeskManagerAdapter;
import com.admin.shopkeeper.base.BaseActivity;
import com.admin.shopkeeper.entity.DeskBean;
import com.admin.shopkeeper.ui.activity.activityOfBoss.deskedit.DeskEditActivity;
...
public class DeskManagerActivity extends BaseActivity<DeskManagerPresenter> implements IDeskManagerView {
    ...
    protected void initPresenter() {
        presenter = new DeskManagerPresenter(this, this);
        presenter.init();
    }
    ...
    public void initView() {
        ...
        recyclerView.addItemDecoration(new HorizontalDividerItemDecoration.Builder(this)
                ...
                .build());
        adapter = new DeskManagerAdapter(R.layout.item_deskmanager);
    ...
    public void showDeletePop(DeskBean bean) {
        ...
        laheiView.findViewById(R.id.pop_edit).setOnClickListener(v -> {
            Intent intent = new Intent(this, DeskEditActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_add:
                startActivityForResult(DeskEditActivity.class, 101);
                break;
        }
    ...
    @Override
    public void success(List<DeskBean> datas) {

...
public class GuaZhangAdapter extends BaseQuickAdapter<GuaZhangBean, BaseViewHolder> {


    public GuaZhangAdapter(@LayoutRes int layoutResId, @Nullable List<GuaZhangBean> data) {

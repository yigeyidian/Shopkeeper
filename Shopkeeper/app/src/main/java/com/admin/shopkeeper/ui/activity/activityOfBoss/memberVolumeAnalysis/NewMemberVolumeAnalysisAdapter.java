...
public class NewMemberVolumeAnalysisAdapter extends PanelAdapter {
    ...
    List<MemberVolumeAnalysisBean> datas = new ArrayList<>();

    public NewMemberVolumeAnalysisAdapter() {
    }
    ...
    public void setDatas(List<MemberVolumeAnalysisBean> datas) {
        this.datas = datas;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int row, int column) {
        ...
        if (row == 0) {
            ...
            MemberVolumeAnalysisBean bean = datas.get(row - 1);
    ...
    private void setDataView(PanelViewHolder holder, int column, MemberVolumeAnalysisBean bean) {
        ...
        switch (column) {
            ...
            case 1:
                ...
                break;
            case 2:
                holder.textView.setText(String.valueOf(bean.getTotal()));

                break;
            case 3:
                holder.textView.setText(String.valueOf(bean.getWeChat()));
                break;
            case 4:
                holder.textView.setText(String.valueOf(bean.getLineOfDown()));
                break;
        }
    }
    ...
    private void setTitleView(PanelViewHolder holder, int column) {
        ...
        switch (column) {
            ...
            case 1:
                ...
                break;
            case 2:
                holder.textView.setText("新增会员");
                break;
            case 3:
                holder.textView.setText("微信");
                break;
            case 4:
                holder.textView.setText("线下");
                break;
        }

...
public class NewIntegralTransactionDetailAdapter extends PanelAdapter {
    ...
    List<IntegralDetailTableBean> datas = new ArrayList<>();

    public NewIntegralTransactionDetailAdapter() {
    }
    ...
    public void setDatas(List<IntegralDetailTableBean> datas) {
        this.datas = datas;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int row, int column) {
        ...
        if (row == 0) {
            ...
            IntegralDetailTableBean bean = datas.get(row - 1);
    ...
    private void setDataView(PanelViewHolder holder, int column, IntegralDetailTableBean bean) {
        ...
        switch (column) {
            ...
            case 2:
                if (!TextUtils.isEmpty(bean.getPhone())) {
                    holder.textView.setText(String.valueOf(bean.getPhone()));
                } else {
                    holder.textView.setText("");
                }
                break;
            case 3:
                holder.textView.setText(String.valueOf(bean.getRechargeAmount()));
                break;
            case 4:
                holder.textView.setText(String.valueOf(bean.getConsumeAmount()));
                break;
            case 5:
                holder.textView.setText(String.valueOf(bean.getAdd()));
                break;
            case 6:
                holder.textView.setText(String.valueOf(bean.getReduce()));
                break;
            default:
    ...
    private void setTitleView(PanelViewHolder holder, int column) {
        ...
        switch (column) {
            ...
            case 2:
                ...
                break;
            case 3:
                holder.textView.setText("累计新增积分");
                break;
            case 4:
                holder.textView.setText("累计消费积分");
                break;
            case 5:
                holder.textView.setText("新增积分");
                break;
            case 6:
                holder.textView.setText("减少积分");
                break;
            default:
                holder.textView.setText("积分余额");
                break;
        }

...
public class MenuDropDownAdapter extends BaseAdapter {
    ...
    public MenuDropDownAdapter(Context context, List<String> list) {
    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                viewHolder.mText.setTextColor(ContextCompat.getColor(context, R.color.drop_down_selected));
                /*viewHolder.mText.setCompoundDrawablesWithIntrinsicBounds(null, null,
                        ContextCompat.getDrawable(context,R.mipmap.drop_down_checked), null);*/
            } else {
